...
namespace Dolphin\Iclients\Controller\Adminhtml\Logo\Image;
...
class Upload extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        try {
            ...
            $basePath = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'iclients/client/';
            $mediaRootDir = $this->filesystem->getDirectoryRead(DirectoryList::MEDIA)->getAbsolutePath() . 'iclients/client/';
            ...
            $imageResult['url'] = $mediaUrl . 'iclients/client/' . $newImageName;
        } catch (\Exception $e) {
