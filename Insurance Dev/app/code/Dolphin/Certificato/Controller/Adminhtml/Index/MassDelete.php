...
class MassDelete extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        foreach ($collection->getItems() as $record) {
			...
			$product = $objectManager->create('Dolphin\Certificato\Model\Certificato')->load($record->getCertificatoId());
            $product->delete();
            $recordDeleted++;
        }
    ...
    {
        return $this->_authorization->isAllowed('Dolphin_Certificato::row_data_delete');
    }
}