...
class Reportcron extends \Magento\Framework\Model\AbstractModel
{
    ...
    public function reportCron()
	{
        ...
        foreach ($results as $val) {
            ...
            if ($val['customer_group_id'] == '3') {
                ...
                $val['doc_signedid'] = $base_url_config."it/insurancepdf/document/showclaim?certificato_code=" . $certificato_code;
