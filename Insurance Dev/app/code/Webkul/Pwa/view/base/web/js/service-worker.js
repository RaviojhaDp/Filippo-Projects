...
var cacheName = 'webkul.sw.pwa.magento.dev.2.0.0';
...
self.addEventListener(
    ...
    function (event) {
        ...
        var baseUrl =  loc.href.substring(0, loc.href.length - ((loc.pathname + loc.search + loc.hash).length - pathName.length));
        fetch(baseUrl+'/pwa/index/getMsgAndSend', {
                mode: 'cors'
            }).then(
                function (response) {
