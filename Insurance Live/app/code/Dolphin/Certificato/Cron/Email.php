...
class Email {
    ...
    \Magento\Framework\Escaper $_escaper, \Magento\Framework\ObjectManagerInterface $objectmanager, \Dolphin\Certificato\Model\CertificatoFactory $certificatoModelFactory, LoggerInterface $logger, \Magento\Framework\Mail\Template\TransportBuilder $_transportBuilder
    ) {
     ...
     public function execute() {
        ...
        $date1 = date('Y-m-d', strtotime($date)); //2020-10-28
		$d2 = date('Y-m-d', strtotime("-1000 days")); //2020-07-30
        //$this->logger->info($date1);
        //$this->logger->info($d2);
