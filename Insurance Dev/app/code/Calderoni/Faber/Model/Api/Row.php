...
class Row extends \Calderoni\Faber\Model\Api
{
	const ENTITY_NAME = "Row";
	//const API_PARAM_DATA_OBJECT = "WAM_V_TMP_ORDINI_ROWS";
	const API_PARAM_DATA_OBJECT = "WAM_V_ORDINI_ROWS";

	const API_URL_TYPE_ROW_ADD = "wamappservice/api/managedata";
	const API_URL_TYPE_ROW_SEARCH = "WamAppTest/api/data";
	const API_URL_TYPE_ROW_EDIT = "wamappservice/api/managedata";
	const API_URL_TYPE_ROW_DELETE = "wamappservice/api/managedata";
	...
	public function addRow($fields=array())
    {
		...
		//{"error":false,"messagetitle":"INFORMATION","messagebody":"FORMCOMMAND_SUCCESSFULL","url":"","clientcommand":"","attach":null,"idRecord":"207","filename":null,"affectedRecord":0,"selectedRecord":0}
		return $returnData;
    }
	
	public function editRow($id,$fields=array())
    {
		$postFields = $this->getPostFields();
		$postFields["Op"] = self::OPERATION_EDIT;
		$postFields["Fields"] = $this->prepareFields($fields, $id);
		$this->setApiUrl(self::API_URL_TYPE_ROW_EDIT);
	...
	public function deleteRow($id)
    {
		...
		$this->setApiUrl(self::API_URL_TYPE_ROW_DELETE);
	...
	public function searchRow($filters,$pageNo=1,$pageSize=1)
    {
		$postFields = $this->getPostFields();
		...
		$this->setApiUrl(self::API_URL_TYPE_ROW_SEARCH);
