...
{
    const API_HOST = "https://testapp.damianigroup.com/";
	...
	public function postToInsurancePdf($postfields = array())
    {
    	...
    	$token = $this->generateAccessToken();
  		...
  		curl_setopt($curl,CURLOPT_URL, "https://testapp.damianigroup.com/wsservice/services/damiani-json/execute?action=PRINT_MODULE");
